...
> Voir [20260705_2215_STRATEGIE_DXY.md](20260705_2215_STRATEGIE_DXY.md) pour l'analyse complète de la stratégie de corrélation.  
...
> Voir [20260705_1640_AUDIT.md](20260705_1640_AUDIT.md) pour le détail des bugs trouvés et corrigés.
...
├── 20260705_1640_AUDIT.md            # Rapport d'audit complet (bugs, corrections, validateurs)
├── 20260705_2215_STRATEGIE_DXY.md    # Documentation stratégie DXY → XAUUSD
├── 20260705_1726_RAPPORT_FTMO.md     # Synthèse backtest 32 symboles FTMO
├── 20260705_1150_a_GUIDE.md            # Guide d'utilisation du bot live
└── 20260705_1150_b_README.md           # Ce fichier
```
...
> ⚠️ Les résultats initiaux (Swing_SR Sharpe 5.5, +170% FTMO) étaient **artificiellement gonflés** par un bug de look-ahead bias. Après correction le 05/07/2026, la réalité est plus sobre. Voir [20260705_1640_AUDIT.md](20260705_1640_AUDIT.md).
