...
### Recherche intraday explorée (Axes A et B)

Deux alternatives intraday ont été testées sur XAGUSD (18 mois) pour diversifier :

| Stratégie | TF | Trades | Retour | Sharpe | Verdict |
|:---|---:|---:|---:|---:|:---|
| **DXY->XAG (1.2σ)** | **H4** | **33** | **+39.26%** | **+1.07** | **Gardée** |
| Mean Reversion | H1 | 7 | +10.07% | +1.12 | Complément viable |
| Ichimoku MTF V2 | M15 | 4 | +0.55% | +0.57 | Non rentable |

> La stratégie DXY H4 reste de loin la meilleure. Mean Reversion H1 est un complément intéressant (faible drawdown, intraday). Ichimoku M15 n'est pas exploitable.
> Détails : `20260705_2258_RECHERCHE_MEAN_REVERSION.md` et `20260705_RECHERCHE_ICHIMOKU_MTF_V2.md`
...
| `strat_compare/20260705_2258_RECHERCHE_MEAN_REVERSION.md` | Recherche Mean Reversion H1 (Sharpe +1.12) |
| `strat_compare/20260705_RECHERCHE_ICHIMOKU_MTF_V2.md` | Recherche Ichimoku MTF Scalping M15 |
