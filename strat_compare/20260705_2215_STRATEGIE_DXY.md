...
## 8. Recherche Intraday Complementaire

> Deux axes de recherche intraday ont ete explores pour diversifier la strategie principale DXY H4.
> Periode : 01/01/2025 -> 03/07/2026 (18 mois) | Actif : XAGUSD

---

### Axe A : Mean Reversion XAGUSD H1

**Concept :** RSI + Bollinger Bands sur H1. Entree quand le prix touche une bande ET RSI en zone survendue/surachetee. SL/TP fixes en ATR.
...
| Max Drawdown | **-2.3%** |
| Profit Factor | **3.55** |
| FTMO Conforme | Oui (min equity $9,582) |
| Rapport | `20260705_2258_RECHERCHE_MEAN_REVERSION.md` |

> **Verdict :** Viable mais peu de trades (7 en 18 mois). Excellent risk management (MaxDD -2.3%). Complementaire au DXY H4.

---

### Axe B : Ichimoku MTF Scalping V2 XAGUSD M15

**Concept :** Flat lines Ichimoku sur H4/D1 comme niveaux institutionnels, breakout trade sur M15. Filtres additionnels : volume, Chikou, Kumo, ADX, session London/NY.

| Metrique | Valeur |
|:---|---:|
| Meilleure config | TF=D FW=10 FTh=0.01 SL=1.2 TP=0.8 Session=ON |
| Trades (18 mois) | 4 |
| Sharpe | +0.57 |
| Retour | +0.55% |
| Configs rentables | **1 sur 72** (Sharpe > 0.5) |
| Configs perdantes | **68 sur 72** |
| FTMO Conforme | Oui (mais seulement +0.53%) |
| Rapport | `20260705_RECHERCHE_ICHIMOKU_MTF_V2.md` |

> **Verdict :** Non rentable. Trop de bruit sur M15, les filtres reduisent trop les signaux (4 trades en 18 mois). L'Ichimoku MTF ne cree pas d'edge sur l'argent en intraday.

---

### Tableau comparatif (XAGUSD, 18 mois)

| Critere | **DXY->XAG (1.2s)** | Mean Rev H1 | Ichimoku M15 |
|:---|---:|---:|---:|
| TF | H4 | H1 | M15 |
| Trades/18mois | **33** | 7 | 4 |
| Retour | **+39.26%** | +10.07% | +0.55% |
| Sharpe | **+1.07** | +1.12 | +0.57 |
| MaxDD | -9.6% | **-2.3%** | -0.6% |
| Win Rate | **51.5%** | 42.9% | 75.0% |
| Profit Factor | 1.70 | **3.55** | 1.97 |
| Intraday | Non (H4) | Oui (H1) | Oui (M15) |

> **DXY->XAGUSD reste la meilleure strategie** (+39.26%, Sharpe +1.07). Mean Reversion H1 est un bon complement pour diversifier (excellent risk, intraday). Ichimoku MTF M15 n'est pas viable.
