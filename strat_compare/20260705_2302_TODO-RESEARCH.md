...
> **Guides :**  
>   - `strat_compare/20260705_2248_a_GUIDE_DXY_BOT.md`  
>   - `strat_compare/20260705_2248_b_GUIDE_XAG_BOT.md`
...
| `strat_compare/20260705_2248_b_GUIDE_XAG_BOT.md` | Guide complet du bot XAGUSD 🆕 |
| `strat_compare/20260705_2248_a_GUIDE_DXY_BOT.md` | Guide complet du bot XAUUSD |
| `strat_compare/20260705_2215_STRATEGIE_DXY.md` | Doc stratégie : analyse corrélation, algo, résultats |
...
| `strat_compare/20260705_2231_b_SPECS_STRATEGIES.md` | Spécifications techniques |
| `strat_compare/20260705_2258_RECHERCHE_MEAN_REVERSION.md` | **RECHERCHE AXE A** — Mean Reversion XAGUSD H1 (Sharpe +1.12, +10.07%) |
| `strat_compare/20260705_RECHERCHE_ICHIMOKU_MTF_V2.md` | **RECHERCHE AXE B** — Ichimoku MTF Scalping V2 M15 (Sharpe +0.57, non rentable) |
| `src/config.py` | `load_env()` pour credentials MT5 |

---

## Axes de recherche intraday explorés

Dans le cadre d'une recherche systématique de stratégies intraday, 4 axes ont été définis. Les axes A et B sont complétés :

### ✅ Axe A — Mean Reversion XAGUSD H1 (COMPLETÉ)

| Métrique | Valeur |
|:---|---:|
| Concept | RSI + Bollinger Bands, retour à la moyenne |
| Résultat | **Viable** — Sharpe +1.12, Ret +10.07%, MaxDD −2.3% |
| Meilleure config | RSI(21) BB(20,1.5) OS=20 OB=85 SL=0.8ATR TP=2.5ATR |
| FTMO | Conforme (min equity $9,582) |
| Rapport | `20260705_2258_RECHERCHE_MEAN_REVERSION.md` |

### ✅ Axe B — Ichimoku MTF Scalping V2 XAGUSD M15 (COMPLETÉ)

| Métrique | Valeur |
|:---|---:|
| Concept | Flat lines Ichimoku H4/D1, breakout M15 + filtres (volume, Chikou, Kumo, ADX, session) |
| Résultat | **Non rentable** — Sharpe +0.57, Ret +0.55%, 4 trades en 18 mois |
| Cause | Trop de bruit sur M15, les filtres réduisent trop les signaux |
| Rapport | `20260705_RECHERCHE_ICHIMOKU_MTF_V2.md` |

### ❌ Axe C — Multi-Asset Momentum (À FAIRE)

**Concept :** Scanner tous les 32 instruments, trader le plus fort momentum du moment.
Cross-sectional momentum : LONG le plus fort, SHORT le plus faible parmi tous les USD pairs.

### ❌ Axe D — ML-Enhanced Signal Filter (À FAIRE)

**Concept :** Random Forest comme filtre de confirmation pour les signaux DXY existants.
Features : RSI, MACD, Bollinger, ATR, session, DXY return. Entraînement walk-forward 2025→2026, test 2026.

---

## Tableau comparatif final (18 mois, XAGUSD)

| Stratégie | TF | Trades | Retour | Sharpe | MaxDD | FTMO | Viable |
|:---|---:|---:|---:|---:|---:|:---|:---|
| **DXY→XAG (1.2σ)** | H4 | 33 | **+39.26%** | +1.07 | −9.6% | Oui | **Oui** |
| Mean Reversion | H1 | 7 | +10.07% | **+1.12** | **−2.3%** | Oui | Oui (compl.) |
| Ichimoku MTF V2 | M15 | 4 | +0.55% | +0.57 | −0.6% | Oui | Limité |

> **DXY→XAGUSD H4 reste la meilleure stratégie.** Mean Reversion H1 est un bon complément pour diversifier (intraday, faible drawdown). Ichimoku M15 n'est pas exploitable.
